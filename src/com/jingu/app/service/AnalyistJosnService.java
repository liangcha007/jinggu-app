...
public class AnalyistJosnService
{
	...
	try
	{
	    ...
	    if (!BaseConst.SUCCESS.equals(states) || "".equals(states) || states == null) { return null; }
	    // 开始解析数组
     ...
     * @return
     */
    public static AddFormBean getAddJobInfo(String JosnStr)
    {
	try
	{
	    AddFormBean formBean = new AddFormBean();
	    ...
	    formBean.setCompand_id(jsonObject.getString(BaseConst.JSON_COMPANY_ID));
	    if (!BaseConst.SUCCESS.equals(states) || "".equals(states) || states == null) { return null; }
	    // 开始解析参数数据
	    List<ItemBean> itemList = new ArrayList<ItemBean>();
	    JSONArray jsonArray = jsonObject.getJSONArray("paras");
	    ...
	    JSONArray jsonArray2 = jsonObject.getJSONArray(BaseConst.JSON_ATTRS);
	    ...
	    // 开始解析rules
	    JSONArray jsonArray3 = jsonObject.getJSONArray(BaseConst.JSON_RULES);
